...
#message = "Visible items: 1: Tie. 2: Frisbee. 3: Bottle. 4: Scissors. 5: Toothbrush. 6: Wrench." + user_input
message = "Visible items: ['hammer', 'screwdriver', 'toothbrush', 'wrench', 'pliers', 'bottle']. Give me a tool for tightening this bolt."
